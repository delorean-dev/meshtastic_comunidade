...
// Camada transparente para não mostrar tiles, só os marcadores
L.tileLayer('', {
  maxZoom: 18
}).addTo(map);

// URL do teu Apps Script Web App (Google Forms)
